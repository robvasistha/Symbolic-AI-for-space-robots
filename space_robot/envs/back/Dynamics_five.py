from space_robot.envs.Matricies.five_dof.C_m import *
from space_robot.envs.Matricies.five_dof.C_vm import *
from space_robot.envs.Matricies.five_dof.C_wm import *
from space_robot.envs.Matricies.five_dof.C_sc_v import *
from space_robot.envs.Matricies.five_dof.C_sc_w import *
from space_robot.envs.Matricies.five_dof.D_m import *
from space_robot.envs.Matricies.five_dof.D_v import *
from space_robot.envs.Matricies.five_dof.D_vm import *
from space_robot.envs.Matricies.five_dof.D_vw import *
from space_robot.envs.Matricies.five_dof.D_w import *
from space_robot.envs.Matricies.five_dof.D_wm import *
from space_robot.envs.Matricies.five_dof.D_wv import *
import numpy as np
...
class Dynamics_five():
    ...
    def space_robot_step(self, action, part_state):
        phi = part_state[3:6]
        theta = part_state[6:11]
        phi_d = part_state[14:17]
        theta_d = part_state[17:22]
